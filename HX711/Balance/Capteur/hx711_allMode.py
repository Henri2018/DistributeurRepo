...
class HX711:
    ...
    def calculateReferenceUnit(self,masse=1,times=25,tareBefore=False):
        if tareBefore:
            self.tare()
...
class HX711Relais:
    def __init__(self,unipi, dout=5, pd_sck=6, gain=128, bitsToRead=24):
        self.PD_SCK = pd_sck
        self.DOUT = dout
        
        '''
        GPIO plus utilise avec Relais
        GPIO.setwarnings(False)
        GPIO.setmode(GPIO.BCM)
        GPIO.setup(self.PD_SCK, GPIO.OUT)
        GPIO.setup(self.DOUT, GPIO.IN)
    ...
    def isReady(self):
        ...
        return GPIO.input(self.DOUT) == 0
        '''
        return self.unipi.di_get(self.DOUT)
    ...
    def setGain(self, gain):
        ...
        GPIO.output(self.PD_SCK, False)
        '''
        self.unipi.relay_set(self.PD_SCK,0)
    ...
    def read(self):
        ...
        for i in range(0, self.bitsToRead):
            ...
            GPIO.output(self.PD_SCK, False)
            '''
            self.unipi.relay_set(self.PD_SCK,1)
            bitValue =self.unipi.di_get(self.DOUT)
            self.unipi.relay_set(self.PD_SCK,0)
...
class HX711AO:
    ...
    def setGain(self, gain):
        ...
        GPIO.output(self.PD_SCK, False)
        '''
        self.unipi.ao_set(self.PD_SCK,0)
    ...
    def read(self):
        ...
        for i in range(0, self.bitsToRead):
            ...
            GPIO.output(self.PD_SCK, False)
            '''
            self.unipi.ao_set(self.PD_SCK,1)
            bitValue =self.unipi.di_get(self.DOUT)
            self.unipi.ao_set(self.PD_SCK,0)
...
class HX711DO:
    ...
    def setGain(self, gain):
        ...
        GPIO.output(self.PD_SCK, False)
        '''
        self.unipi.do_set(self.PD_SCK,0)
    ...
    def read(self):
        ...
        for i in range(0, self.bitsToRead):
            ...
            GPIO.output(self.PD_SCK, False)
            '''
            self.unipi.do_set(self.PD_SCK,1)
            bitValue =self.unipi.di_get(self.DOUT)
            self.unipi.do_set(self.PD_SCK,0)
